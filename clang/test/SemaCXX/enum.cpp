// RUN: %clang_cc1 -debug-column-info -fsyntax-only -pedantic -std=c++98 -verify -triple x86_64-apple-darwin %s
// RUN: %clang_cc1 -debug-column-info -fsyntax-only -pedantic -std=c++11 -verify -triple x86_64-apple-darwin %s
