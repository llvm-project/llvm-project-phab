...
// RUN: %clang_cc1 -triple x86_64-apple-darwin -O0 -disable-llvm-passes -force-tbaa %s -emit-llvm -o - | FileCheck %s -check-prefix=PATH
...
// RUN: %clang_cc1 -triple x86_64-apple-darwin -O1 -relaxed-aliasing -disable-llvm-passes -force-tbaa %s -emit-llvm -o - | FileCheck %s -check-prefix=PATH
