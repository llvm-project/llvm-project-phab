...
void test_deprecated_or_unsafe_buffer_handling_1() {
  ...
  fscanf(file, "%4s", buf); // expected-warning{{Using 'fscanf' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'fscanf_s'}}
  ...
  sscanf("5", "%d", &a); // expected-warning{{Using 'sscanf' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'sscanf_s'}}
  ...
  sscanf("5", "%4s", buf); // expected-warning{{Using 'sscanf' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'sscanf_s'}}
  ...
  swprintf(L"5", 1, (const wchar_t*) L"%s", wbuf); // expected-warning{{Using 'swprintf' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'swprintf_s'}}
  snprintf("5", 1, "%s", buf); // expected-warning{{Using 'snprintf' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'snprintf_s'}}
  memcpy(buf, wbuf, 1); // expected-warning{{Using 'memcpy' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'memcpy_s'}}
  memmove(buf, wbuf, 1); // expected-warning{{Using 'memmove' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'memmove_s'}}
  strncpy(buf, "a", 1); // expected-warning{{Using 'strncpy' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'strncpy_s'}}
  strncat(buf, "a", 1); // expected-warning{{Using 'strncat' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'strncat_s'}}
  memset(buf, 'a', 1); // expected-warning{{Using 'memset' is deprecated as it does not provide bounding of the memory buffer or security checks introduced in the C11 standard. Replace with analogous functions introduced in C11 standard that supports length arguments or provides boundary checks such as 'memset_s'}}
}
