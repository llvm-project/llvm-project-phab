...
// CHECK-NEXT:     <key>depth</key><integer>0</integer>
// CHECK-NEXT:     <key>extended_message</key>
// CHECK-NEXT:     <string>Assuming &apos;y&apos; == 2</string>
// CHECK-NEXT:     <key>message</key>
// CHECK-NEXT:     <string>Assuming &apos;y&apos; == 2</string>
// CHECK-NEXT:    </dict>
// CHECK-NEXT:    <dict>
...
// CHECK-NEXT:     <key>depth</key><integer>1</integer>
// CHECK-NEXT:     <key>extended_message</key>
// CHECK-NEXT:     <string>Assuming &apos;fail&apos; == 1</string>
// CHECK-NEXT:     <key>message</key>
// CHECK-NEXT:     <string>Assuming &apos;fail&apos; == 1</string>
// CHECK-NEXT:    </dict>
// CHECK-NEXT:    <dict>
...
// CHECK-NEXT:     <key>depth</key><integer>1</integer>
// CHECK-NEXT:     <key>extended_message</key>
// CHECK-NEXT:     <string>Entered call from &apos;testLoopOpaqueCollection&apos;</string>
// CHECK-NEXT:     <key>message</key>
// CHECK-NEXT:     <string>Entered call from &apos;testLoopOpaqueCollection&apos;</string>
// CHECK-NEXT:    </dict>
// CHECK-NEXT:    <dict>
...
// CHECK-NEXT:     <key>depth</key><integer>1</integer>
// CHECK-NEXT:     <key>extended_message</key>
// CHECK-NEXT:     <string>Assuming &apos;fail&apos; == 0</string>
// CHECK-NEXT:     <key>message</key>
// CHECK-NEXT:     <string>Assuming &apos;fail&apos; == 0</string>
// CHECK-NEXT:    </dict>
// CHECK-NEXT:    <dict>
...
// CHECK-NEXT:     <key>depth</key><integer>0</integer>
// CHECK-NEXT:     <key>extended_message</key>
// CHECK-NEXT:     <string>Returning from &apos;get&apos;</string>
// CHECK-NEXT:     <key>message</key>
// CHECK-NEXT:     <string>Returning from &apos;get&apos;</string>
// CHECK-NEXT:    </dict>
// CHECK-NEXT:    <dict>
