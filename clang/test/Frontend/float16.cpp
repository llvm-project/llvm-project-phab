...
//CHECK:        `-ImplicitCastExpr {{.*}} 'long double' <FloatingCast>
//CHECK:          `-ImplicitCastExpr {{.*}} '_Float16' <LValueToRValue>
//CHECK:            `-DeclRefExpr {{.*}} '_Float16' lvalue Var {{.*}} 'f2n' '_Float16'
...
//CHECK:       `-ImplicitCastExpr {{.*}} '_Float16' <FloatingCast>
//CHECK:         `-FloatingLiteral {{.*}} 'float' 4.200000e+01

  _Float16 d2h = 42.0;
//CHECK:     `-VarDecl {{.*}} d2h '_Float16' cinit
//CHECK:       `-ImplicitCastExpr {{.*}} '_Float16' <FloatingCast>
//CHECK:         `-FloatingLiteral {{.*}} 'double' 4.200000e+01

  _Float16 ld2h = 42.0l;
//CHECK:      `-VarDecl {{.*}} ld2h '_Float16' cinit
//CHECK:        `-ImplicitCastExpr {{.*}} '_Float16' <FloatingCast>
//CHECK:          `-FloatingLiteral {{.*}} 'long double' 4.200000e+01
}
