...
// CHECK-DAG:  call void @_ZN2C1C2EDh(%class.C1* %c1, half [[F1L]])
...
// CHECK-X86-DAG:     @_ZZ4mainE5arr1l = private unnamed_addr constant [3 x i16] [i16 -17408, i16 -32768, i16 -13952], align 2
  ...
  printf("Hello _Float16 World: %f", f2l);
//CHECK-AARCH64-DAG: %12 = load half, half* %f2l, align 2
//CHECK-AARCH64-DAG: %conv = fpext half %12 to double
//CHECK-AARCH64-DAG: %call11 = call i32 (i8*, ...) @_Z6printfPKcz(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), double %conv)
}
