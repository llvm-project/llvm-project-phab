...
void Parser::initializePragmaHandlers() {
  ...
  if (getLangOpts().MicrosoftExt) {
    MSDetectMismatchHandler = llvm::make_unique<PragmaDetectMismatchHandler>(Actions);
  ...
  if (getLangOpts().CUDA) {
    CUDAForceHostDeviceHandler = llvm::make_unique<PragmaForceCUDAHostDeviceHandler>(
        Actions);
  ...
  AttributePragmaHandler = llvm::make_unique<PragmaAttributeHandler>(AttrFactory);
