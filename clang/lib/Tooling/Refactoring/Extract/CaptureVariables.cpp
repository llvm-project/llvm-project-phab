...
public:
  ...
  // FIXME: Track variables defined in extracted code.
...
void CapturedExtractedEntity::printParamDecl(llvm::raw_ostream &OS,
...
void CapturedExtractedEntity::printUseExpr(llvm::raw_ostream &OS,
                                           const PrintingPolicy &PP) const {
...
StringRef CapturedExtractedEntity::getName() const {
  switch (Kind) {
  case CapturedVarDecl:
    return VD->getName();
  }
