...
void MicrosoftCXXNameMangler::mangleCallingConvention(CallingConv CC) {
  ...
  //                      ::= Q # __vectorcall
  //                      ::= w # __regcall
  //                      ::= __swift::swift_cc:: # __swiftcall (will change when Microsoft adds this to their scheme)
  ...
  switch (CC) {
    ...
    case CC_Swift: Out << "__swift::swift_cc::"; break;
  }
}
void MicrosoftCXXNameMangler::mangleCallingConvention(const FunctionType *T) {  mangleCallingConvention(T->getCallConv());
}
