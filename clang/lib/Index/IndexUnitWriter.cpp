...
void IndexUnitWriter::writeDependencies(llvm::BitstreamWriter &Stream,
  ...
  // Dependency kind
  Abbrev->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::Fixed, UnitDependencyKindBitNum));
...
void IndexUnitWriter::writePaths(llvm::BitstreamWriter &Stream,
  ...
  // Path prefix kind
  PathAbbrev->Add(BitCodeAbbrevOp(BitCodeAbbrevOp::Fixed,
                                  UnitFilePathPrefixKindBitNum));
