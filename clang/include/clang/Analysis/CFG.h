...
/// CFGScopeBegin - Represents beginning of a scope implicitly
/// generated by the compiler on encountering a CompoundStmt
...
/// CFGScopeEnd - Represents end of a scope implicitly generated
/// by the compiler after the last Stmt in a CompoundStmt's body
  ...
  public:
    ...
    BuildOptions()
      : forcedBlkExprs(nullptr), Observer(nullptr),
        ...
        AddTemporaryDtors(false), AddScopeInfo(false),
