...
namespace {
  ...
  bool handleDiagnostics(const DiagnosticInfo &DI, void *Context) override {
...
int main(int argc, char **argv) {
  ...
  LLVMContext Context;
  Context.setDiagnosticHandler(llvm::make_unique<LLVMLinkDiagnosticHandler>(), nullptr, true);
