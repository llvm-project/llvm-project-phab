...
TEST(CommandLineTest, ConfigFileErrors) {
  ...
  Result = cl::findConfigFileFromArgs(CfgFileName, Argv, Dirs);
...
TEST(CommandLineTest, ReadDefaultConfigFile) {
  ...
  llvm::SmallString<128> CfgFileName;
  cl::SearchResult Result = cl::findDefaultCfgFile(CfgFileName,
                                 ArrayRef<const char *>(), Argv[0], "test.cfg");
...
TEST(CommandLineTest, ReadDefaultConfigFileFromStdDir) {
  ...
  llvm::SmallString<128> CfgFileName;
  cl::SearchResult Result = cl::findDefaultCfgFile(CfgFileName, Dirs, Argv[0],
                                                   "test.cfg");
