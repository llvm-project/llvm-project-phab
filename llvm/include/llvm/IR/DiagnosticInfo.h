...
public:
  ...
  bool isEnabled() const override {
    return DiagnosticHandler::isPassedOptRemarkEnable(getPassName().str());
}
...
public:
  ...
  /// \see DiagnosticInfoOptimizationBase::isEnabled.
  bool isEnabled() const override {
    return DiagnosticHandler::isMissedOptRemarkEnable(getPassName().str());
  }
...
public:
  ...
  /// \see DiagnosticInfoOptimizationBase::isEnabled.
  bool isEnabled() const override {
    return DiagnosticHandler::isAnalysisRemarkEnable(getPassName().str()) ||
          shouldAlwaysPrint();
  }
