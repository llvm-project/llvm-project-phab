...
public:
  /// A fully specified VectorType is of the form <m x n x Ty>. 'n' is the
  /// minimum number of elements of type Ty contained within the vector, 'm'
  /// indicates multiples of the minimum and the total element count is
  /// the result of 'm' * 'n'. However, for all targets 'm' is expected to be
  /// either statically unknown at compile time or guaranteed to be one.
  /// If 'm' is known to be 1, then the extra term is discarded in textual IR:
  ///
  /// <4 x i32>     - a vector containing 4 i32s
  /// <m x 4 x i32> - a vector containing an unknown integer multiple of 4 i32s
  class ElementCount {
  public:
