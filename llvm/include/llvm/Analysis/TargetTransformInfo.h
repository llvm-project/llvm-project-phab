...
public:
  ...
  /// \brief Return true if the input function which is cold at all callsites,
  ///  should use coldcc calling conv.
...
public:
  ...
  virtual bool useColdCCForColdCalls(Function &F) = 0;
  virtual unsigned
...
public:
  ...
  bool useColdCCForColdCalls(Function &F) override {
    return Impl.useColdCCForColdCalls(F);
  }
