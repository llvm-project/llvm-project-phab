...
bool namespaceOverrides(const unsigned char *HRef1,
  ...
  if (HRef1Position == MtNsHrefsPrefixes.end())
    return false;
  ...
  if (HRef2Position == MtNsHrefsPrefixes.end())
    return true;
  int HRef1Priority = std::distance(HRef1Position, MtNsHrefsPrefixes.end());
  int HRef2Priority = std::distance(HRef2Position, MtNsHrefsPrefixes.end());
