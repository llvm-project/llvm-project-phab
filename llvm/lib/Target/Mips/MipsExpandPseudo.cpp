...
bool MipsExpandPseudo::expandAtomicCmpSwapSubword(
  ...
  computeLiveIns(LiveRegs, *MRI, *exitMBB);
  ...
  computeLiveIns(LiveRegs, *MRI, *loop1MBB);
  ...
  BuildMI(loop2MBB, DL, TII->get(BEQ))
      ...
      .addReg(ZERO)
      .addMBB(loop1MBB);
  computeLiveIns(LiveRegs, *MRI, *loop2MBB);
  ...
  computeLiveIns(LiveRegs, *MRI, *sinkMBB);
...
bool MipsExpandPseudo::expandAtomicBinOpSubword(
  ...
  computeLiveIns(LiveRegs, *MRI, *loopMBB);
