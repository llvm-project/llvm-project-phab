...
bool AArch64InstrInfo::isExynosShiftExtFast(const MachineInstr &MI) const {
  ...
  case AArch64::SUBXrs:
    ...
    Type = AArch64_AM::getShiftType(Imm);
    return (Shift <= 3 &&  Type == AArch64_AM::LSL);
  ...
  case AArch64::SUBXrx64:
    ...
    Type = AArch64_AM::getExtendType(Imm);
    return (Shift <= 3 && Type == AArch64_AM::UXTX);
  }
}
