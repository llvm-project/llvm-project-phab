...
// The limit of the program size to apply agressive inlining. With a lot of
// inlining we suffer a very slow compilation for huge programs and this
// threshold is to mitigate it.
