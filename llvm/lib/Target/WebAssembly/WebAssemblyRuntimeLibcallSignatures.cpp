...
struct RuntimeLibcallSignatureTable {
  ...
  RuntimeLibcallSignatureTable() {
    ...
    Table[RTLIB::FPROUND_F64_F16] = unsupported;
    Table[RTLIB::FPROUND_F80_F16] = unsupported;
    Table[RTLIB::FPROUND_F128_F16] = unsupported;
    Table[RTLIB::FPROUND_PPCF128_F16] = unsupported;
    Table[RTLIB::FPROUND_F64_F32] = f32_func_f64;
    Table[RTLIB::FPROUND_F80_F32] = unsupported;
    Table[RTLIB::FPROUND_F128_F32] = f32_func_i64_i64;
    Table[RTLIB::FPROUND_PPCF128_F32] = unsupported;
    Table[RTLIB::FPROUND_F80_F64] = unsupported;
    Table[RTLIB::FPROUND_F128_F64] = f64_func_i64_i64;
    Table[RTLIB::FPROUND_PPCF128_F64] = unsupported;
    ...
    Table[RTLIB::FPTOSINT_F80_I32] = unsupported;
    Table[RTLIB::FPTOSINT_F80_I64] = unsupported;
    Table[RTLIB::FPTOSINT_F80_I128] = unsupported;
    ...
    Table[RTLIB::FPTOSINT_PPCF128_I32] = unsupported;
    Table[RTLIB::FPTOSINT_PPCF128_I64] = unsupported;
    Table[RTLIB::FPTOSINT_PPCF128_I128] = unsupported;
    ...
    Table[RTLIB::FPTOUINT_F80_I32] = unsupported;
    Table[RTLIB::FPTOUINT_F80_I64] = unsupported;
    Table[RTLIB::FPTOUINT_F80_I128] = unsupported;
    ...
    // EXCEPTION HANDLING
    Table[RTLIB::UNWIND_RESUME] = unsupported;
    ...
    // Deoptimization.
    Table[RTLIB::DEOPTIMIZE] = unsupported;
  }
};

static ManagedStatic<RuntimeLibcallSignatureTable> RuntimeLibcallSignatures;
