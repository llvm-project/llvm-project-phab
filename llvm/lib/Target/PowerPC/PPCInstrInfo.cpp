...
// Heuristic to choose between a VSX instruction and a FP instruction. The VSX
// versions have the advantage of a full 64-register target whereas the FP ones
// have the advantage of lower latency and higher throughput. So what we are
// after is using the faster instructions in low register pressure situations
...
bool PPCInstrInfo::expandPostRAPseudo(MachineInstr &MI) const {
  ...
  case PPC::DFSTOREf64: {
    ...
    return targetInstrHeuristic(MI);
  }
  case PPC::XFLOADf32:
  case PPC::XFLOADf64:
  case PPC::XFSTOREf32:
