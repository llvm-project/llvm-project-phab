...
static bool ShouldUpgradeX86Intrinsic(Function *F, StringRef Name) {
  ...
  // point.
  if (Name.startswith("avx512.mask.pbroadcast.b.gpr") || // Added in 6.0
      Name.startswith("avx512.mask.pbroadcast.w.gpr") || // Added in 6.0
      Name.startswith("avx512.mask.pbroadcast.d.gpr") || // Added in 6.0
      Name.startswith("avx512.mask.pbroadcast.q.gpr") || // Added in 6.0
