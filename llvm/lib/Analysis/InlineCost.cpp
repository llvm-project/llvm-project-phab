...
public:
  CallAnalyzer(const TargetTransformInfo &TTI,
      ...
      : TTI(TTI), GetAssumptionCache(GetAssumptionCache), GetBFI(GetBFI),
        ...
        TenPercentVectorBonus(0), VectorBonus(0), SingleBBBonus(0),
...
void CallAnalyzer::updateThreshold(CallSite CS, Function &Callee) {
  ...
  // large bonus is applied if the vector instructions exceed 50% and a smaller
  // bonus is applied if it exceeds 10%. Note that these bonuses are some what
  ...
  int SmallVectorBonusPercent = 75;
  int LargeVectorBonusPercent = 150;
  int LastCallToStaticBonus = InlineConstants::LastCallToStaticBonus;

  // Lambda to set all the above bonus and bonus percentages to 0.
  auto DisallowAllBonuses = [&]() {
    SingleBBBonusPercent = 0;
    SmallVectorBonusPercent = 0;
    LargeVectorBonusPercent = 0;
  ...
  FiftyPercentVectorBonus = Threshold * LargeVectorBonusPercent / 100;
  TenPercentVectorBonus = Threshold * SmallVectorBonusPercent / 100;
