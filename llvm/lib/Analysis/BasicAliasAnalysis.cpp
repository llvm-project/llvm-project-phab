...
AliasResult BasicAAResult::aliasGEP(const GEPOperator *GEP1, uint64_t V1Size,
  ...
  if (!DecompGEP1.VarIndices.empty()) {
    ...
    if (V1Size != MemoryLocation::UnknownSize &&
        V2Size != MemoryLocation::UnknownSize && ModOffset.uge(V2Size) &&
        (Modulo - ModOffset).uge(V1Size))
      return NoAlias;
...
bool BasicAAResult::constantOffsetHeuristic(
    ...
    uint64_t V2Size, APInt BaseOffset, AssumptionCache *AC,
    DominatorTree *DT) {
