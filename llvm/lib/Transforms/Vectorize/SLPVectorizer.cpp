...
void BoUpSLP::buildTree_rec(ArrayRef<Value *> VL, unsigned Depth,
  ...
  // Avoid any vectors here that are wider than two elements and
  // with real operations less than half of vector to others members
  // are operands to that operations.
  unsigned AltOpcode = getAltOpcode(S.Opcode);
