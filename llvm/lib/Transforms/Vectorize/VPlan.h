...
private:
  /// \return true if the given VPBlockBase and its successors will produce a
  /// single basic block when vectorized, recursively. \returns false otherwise.
  bool willProduceSingleBasicBlock(const VPBlockBase *Block) const;
