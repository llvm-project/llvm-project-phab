...
struct LTODiagnosticHandler : public DiagnosticHandler {
  LTODiagnosticHandler(void *Context) : DiagnosticHandler(Context) {}
  bool handleDiagnostics(const DiagnosticInfo &DI) override {
    ((LTOCodeGenerator *)DiagnosticContext)->DiagnosticHandler(DI);
    return true;
  }
};
}
...
LTOCodeGenerator::setDiagnosticHandler(lto_diagnostic_handler_t DiagHandler,
  ...
  Context.setDiagnosticHandler(
    llvm::make_unique<LTODiagnosticHandler>(this), true);
}
