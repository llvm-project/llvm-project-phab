...
;
; CHECK-DWARF:  "res"
;  piece 0x00000004, edx, piece 0x00000004
; CHECK-DWARF:  93 04 52 93 04

; ModuleID = 'sdagsplit-2.c'
...
entry:
  ...
  %add = add nsw i64 %c, 1, !dbg !20
  tail call void @llvm.dbg.value(metadata !{i64 %add}, i64 0, metadata !13), !dbg !21
  %cmp = icmp eq i64 %a, %b, !dbg !22
  %add1 = select i1 %cmp, i64 0, i64 %b, !dbg !22
  %retval.0 = add nsw i64 %add, %add1, !dbg !22
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.6.0 ", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/sdagsplit-2.c] [DW_LANG_C99]
!1 = metadata !{metadata !"sdagsplit-2.c", metadata !""}
!2 = metadata !{}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"foo", metadata !"foo", metadata !"", i32 2, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i64 (i64, i64, i64)* @foo, null, null, metadata !9, i32 3} ; [ DW_TAG_subprogram ] [line 2] [def] [scope 3] [foo]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/sdagsplit-2.c]
...
!12 = metadata !{i32 786689, metadata !4, metadata !"c", metadata !5, i32 50331650, metadata !8, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [c] [line 2]
...
!20 = metadata !{i32 4, i32 4, metadata !4, null}
!21 = metadata !{i32 4, i32 14, metadata !4, null}
!22 = metadata !{i32 5, i32 9, metadata !23, null}
!23 = metadata !{i32 786443, metadata !1, metadata !4, i32 5, i32 9, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/sdagsplit-2.c]
