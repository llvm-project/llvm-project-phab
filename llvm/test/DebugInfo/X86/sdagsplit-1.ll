...
;    }
;
; CHECK-DWARF: DW_AT_location [DW_FORM_data4]        ([[LOC:.*]])
; CHECK-DWARF-NEXT:  DW_AT_name {{.*}}"res"
; CHECK-DWARF: .debug_loc
; CHECK-DWARF: [[LOC]]:
; eax, piece 0x00000004, edx, piece 0x00000004
; CHECK-DWARF:   Location description: 50 93 04 52 93 04
