...
; CHECK: Both ModRef (MustAlias):  Ptr: i8* %p <->  call void @another_argmemonly_func(i8* %p, i8* %q)
; CHECK: Both ModRef (MustAlias):  Ptr: i8* %q <->  call void @another_argmemonly_func(i8* %p, i8* %q)
}
