...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_LDM_ADD Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_LDM_CALL Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_LDO_ADD Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:  33 00 00 00  sethi 0, %i1
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_IE_HI22 Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_IE_LO10 Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_IE_LD Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_IE_LDX Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_IE_ADD Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:  33 00 00 00  sethi 0, %i1
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_GD_HI22 Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:  b2 06 60 00  add %i1, 0, %i1
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_GD_LO10 Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_GD_ADD Unknown
...
! OBJDUMP: {{[0-9,a-f]+}}:  40 00 00 00 call 0
! OBJDUMP: {{[0-9,a-f]+}}:     R_SPARC_TLS_GD_CALL Unknown
