...
; CHECK-LABEL: @caller1
; CHECK: codeRepl.i:
; CHECK-NEXT:  call void (i32, i8**, i32, ...) @vararg.1_bb1(i32 %stat1.i, i8** %vargs.i, i32 %arg)
...
; CHECK-LABEL: @caller2
; CHECK: codeRepl.i:
; CHECK-NEXT:  call void (i32, i8**, i32, ...) @vararg.1_bb1(i32 %stat1.i, i8** %vargs.i, i32 %arg, i32 10, float %arg2)
