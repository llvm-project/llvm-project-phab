...
; irreducible loop by SimplifyPartiallyRedundantLoad(). Note this test contain
; unswithch opportunity in %while.cond2, so we want to keep %while.cond2 as a
; loop header.
; CHECK-LABEL: @fn_keep_loop
; CHECK-NOT: while.cond2thread-pre-split  
