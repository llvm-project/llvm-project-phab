...
define i32 @outer17(i1 %cond) {
; CHECK-LABEL: @outer17(
; CHECK: call i32 @inner17
  %A = alloca i32
  %C = call i32 @inner17(i1 %cond, i32* %A)
  ret i32 %C
}

define i32 @inner17(i1 %cond, i32* %ptr) {
entry:
  br i1 %cond, label %if_true, label %exit
...
exit:
  %phi = phi i32* [null, %entry], [%ptr, %if_true] ; Cannot be simplified
  %load = load i32, i32* %phi
  call void @pad()
  ret i32 %load
}
