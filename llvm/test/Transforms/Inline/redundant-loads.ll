...
define void @outer5_1(i32* %a, i8* %ptr) {
; CHECK-LABEL: @outer5_1(
; CHECK-NOT: call void @inner5_1
  call void @inner5_1(i32* %a, i8* %ptr)
  ret void
}

declare void @llvm.lifetime.start.p0i8(i64, i8* nocapture) argmemonly nounwind

define void @inner5_1(i32* %a, i8* %ptr) {
  %1 = load i32, i32* %a
...
define void @outer6(i32* %a) {
; CHECK-LABEL: @outer6(
; CHECK-NOT: call void @inner6
  call void @inner6(i32* %a)
  ret void
}

declare void @ext2() readnone

define void @inner6(i32* %a) {
  %1 = load i32, i32* %a
...
; CHECK-NOT: call void @inner7
  call void @inner7(i32* %a, void ()* @ext2)
  ret void
}

define void @inner7(i32* %a, void ()* %f) {
  %1 = load i32, i32* %a
