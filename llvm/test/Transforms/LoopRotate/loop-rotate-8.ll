...
; CHECK-LABEL: bar
; CHECK: for.cond.preheader:                               ; preds = %if.end
; CHECK: for.cond.lr:                                      ; preds = %for.cond.preheader
; CHECK: for.body.lr:                                      ; preds = %for.cond.lr
; CHECK: if.end20.lr.ph:                                   ; preds = %for.body.lr
