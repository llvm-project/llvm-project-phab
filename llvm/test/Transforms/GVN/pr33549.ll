...
; The purpose of this test is to make sure that the load(%2) is pre'd.
...
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, i32* [[ARRAYIDX]], align 4, !tbaa !3
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, i32* [[ARRAYIDX4]], align 4, !tbaa !3
; CHECK-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP1]], [[TMP0]]
; CHECK-NEXT:    store i32 [[SUB]], i32* [[ARRAYIDX]], align 4, !tbaa !3
; CHECK-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP1]], [[TMP0]]
; CHECK-NEXT:    store i32 [[ADD7]], i32* [[ARRAYIDX4]], align 4, !tbaa !3
