...
attributes #0 = { hasvectorvariants norecurse nounwind uwtable "_ZGVbM4ul_foo" "_ZGVbN4ul_foo" "_ZGVcM8ul_foo" "_ZGVcN8ul_foo" "_ZGVdM8ul_foo" "_ZGVdN8ul_foo" "_ZGVeM16ul_foo" "_ZGVeN16ul_foo" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
