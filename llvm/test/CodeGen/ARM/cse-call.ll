...
define i8* @F_floatmul(i8* %f1, i8* %f2, i1 %cond) nounwind ssp {
entry:
  br i1 %cond, label %while.end42, label %while.body37
...
while.end42:                                      ; preds = %while.body37, %entry
  %. = select i1 %cond, i8* getelementptr inbounds ([200 x i8], [200 x i8]* @F_floatmul.man1, i32 0, i32 0), i8* getelementptr inbounds ([200 x i8], [200 x i8]* @F_floatmul.man2, i32 0, i32 0)
  %.92 = select i1 %cond, i8* getelementptr inbounds ([200 x i8], [200 x i8]* @F_floatmul.man2, i32 0, i32 0), i8* getelementptr inbounds ([200 x i8], [200 x i8]* @F_floatmul.man1, i32 0, i32 0)
