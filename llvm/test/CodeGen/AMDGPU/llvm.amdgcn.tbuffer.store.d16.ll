...
;UNPACKED-LABEL: {{^}}tbuffer_store_d16_x:
;UNPACKED: tbuffer_store_format_d16_x  v0, v1, s[4:7],  dfmt:1,  nfmt:2, 0 idxen
;UNPACKED: s_endpgm

;PACKED-LABEL: {{^}}tbuffer_store_d16_x:
;PACKED: tbuffer_store_format_d16_x  v0, v1, s[4:7],  dfmt:1,  nfmt:2, 0 idxen
;PACKED: s_endpgm
...
;UNPACKED-LABEL: {{^}}tbuffer_store_d16_xy:
;UNPACKED: tbuffer_store_format_d16_xy  v[0:1], v2, s[4:7],  dfmt:1,  nfmt:2, 0 idxen
;UNPACKED: s_endpgm

;PACKED-LABEL: {{^}}tbuffer_store_d16_xy:
