; RUN: opt -mtriple=amdgcn---amdgiz -loop-unroll -simplifycfg -sroa %s -S -o - | FileCheck %s
; RUN: opt -mtriple=r600---amdgiz -loop-unroll -simplifycfg -sroa %s -S -o - | FileCheck %s
