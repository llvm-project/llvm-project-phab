...
; CHECK: %alloca = alloca [64 x i32], align 4, addrspace(5)
...
;     #pragma nounroll
;     for (int addrspace(5)* p = &alloca[2], *e = &alloca[48]; p != e; ++p, ++i)
;     {
;         *p = i;
;     }
; }
...
; extern int addrspace(5)* get_unknown_pointer(void);
...
;     int i = 0;
;
;     for (int addrspace(5)* p = &alloca[2], *e = get_unknown_pointer(); p != e; ++p, ++i)
;     {
;         *p = i;
;     }
; }
