...
; RUN-TODO: llc -march=mips64 -mcpu=mips4 -mabi=o32 < %s | FileCheck %s -check-prefix=ALL -check-prefix=4-O32-NOFPXX
; RUN-TODO: llc -march=mips64 -mcpu=mips4 -mabi=o32 -mattr=fpxx < %s | FileCheck %s -check-prefix=ALL -check-prefix=4-O32-FPXX

; RUN-TODO: llc -march=mips64 -mcpu=mips64 -mabi=o32 < %s | FileCheck %s -check-prefix=ALL -check-prefix=64-O32-NOFPXX
; RUN-TODO: llc -march=mips64 -mcpu=mips64 -mabi=o32 -mattr=fpxx < %s | FileCheck %s -check-prefix=ALL -check-prefix=64-O32-FPXX
