...
; RUN: llc -march=mips -mcpu=mips64   -mabi=n64 < %s | FileCheck %s -check-prefix=ALL -check-prefix=64
; RUN: llc -march=mips -mcpu=mips64r2 -mabi=n64 < %s | FileCheck %s -check-prefix=ALL -check-prefix=64
; RUN: llc -march=mips -mcpu=mips64r6 -mabi=n64 < %s | FileCheck %s -check-prefix=ALL -check-prefix=64R6
