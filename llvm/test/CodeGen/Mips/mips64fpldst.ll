...
; RUN: llc  < %s -march=mipsel -mcpu=mips64r6 -mattr=+micromips -mabi=n32 -relocation-model=pic | FileCheck %s -check-prefix=CHECK-N32
; RUN: llc  < %s -march=mipsel -mcpu=mips64r6 -mattr=+micromips -mabi=n64 -relocation-model=pic | FileCheck %s -check-prefix=CHECK-N64
