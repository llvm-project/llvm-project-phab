...
; CHECK: SU(3):   STRWui %WZR<norename>, %vreg0, 0; mem:ST4[%ptr1] GPR64common:%vreg0
; CHECK:   Successors:
; CHECK: SU(4): Ord  Latency=0
; CHECK: SU(4):   STRWui %WZR<norename>, %vreg1, 0; mem:ST4[%ptr2] GPR64common:%vreg1
; CHECK: SU(5):   %W0<def,norename> = COPY %vreg2; GPR32:%vreg2
