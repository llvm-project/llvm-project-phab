; RUN: llc < %s -ppc-ignore-percent-prefix \
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=pwr7 | FileCheck %s
; RUN: llc < %s -ppc-ignore-percent-prefix \
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=a2 \
; RUN:   | FileCheck -check-prefix=CHECK-NOAV %s
