; RUN: llc -verify-machineinstrs -mtriple=powerpc64le-unknown-linux-gnu -ppc-enable-coldcc  < %s | FileCheck %s -check-prefix=COLDCC
...
define internal fastcc signext i32 @callee(i32 signext %a, i32 signext %b) unnamed_addr #0 {
; COLDCC: @callee
; COLDCC: std 6, -8(1)
; COLDCC: std 7, -16(1)
; COLDCC: std 8, -24(1)
