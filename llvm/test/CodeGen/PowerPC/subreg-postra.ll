; RUN: llc -verify-machineinstrs -mcpu=pwr7 < %s -ppc-strip-register-prefix\
; RUN:   | FileCheck %s
; RUN: llc -verify-machineinstrs -mcpu=pwr7 -ppc-gen-isel=false < %s \
; RUN:   -ppc-strip-register-prefix | FileCheck --check-prefix=CHECK-NO-ISEL %s
