; RUN: llc -verify-machineinstrs -ppc-ignore-percent-prefix -mcpu=pwr7 < %s \
; RUN:   | FileCheck %s -check-prefix=PWR7
; RUN: llc -verify-machineinstrs -ppc-ignore-percent-prefix -mcpu=pwr8 < %s \
; RUN:   | FileCheck %s -check-prefix=PWR8
; RUN: llc -verify-machineinstrs -ppc-ignore-percent-prefix -mcpu=a2q < %s \
