; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix -mcpu=pwr7 < %s \
; RUN:   | FileCheck %s -check-prefix=PWR7
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix -mcpu=pwr8 < %s \
; RUN:   | FileCheck %s -check-prefix=PWR8
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix -mcpu=a2q < %s \
; RUN:   | FileCheck %s -check-prefix=A2Q
