; RUN: llc -ppc-ignore-percent-prefix -verify-machineinstrs -mattr=-vsx \
; RUN:   -mattr=+altivec -mcpu=pwr7 < %s | FileCheck %s
; RUN: llc -ppc-ignore-percent-prefix -verify-machineinstrs -mattr=+vsx \
; RUN:   -mattr=+altivec -mcpu=pwr7 < %s | FileCheck -check-prefix=CHECK-VSX %s
