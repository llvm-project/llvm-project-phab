...
; RUN:   -mtriple=ppc64-- -mcpu=a2 | FileCheck -check-prefix=CHECK-A2 %s
; RUN: llc -verify-machineinstrs < %s -ppc-strip-register-prefix \
; RUN:   -mtriple=ppc64-- -mcpu=a2q | FileCheck -check-prefix=CHECK-A2Q %s
; RUN: llc -verify-machineinstrs < %s -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc64-bgq-linux -mcpu=a2 | FileCheck \
; RUN:   -check-prefix=CHECK-BGQ %s
