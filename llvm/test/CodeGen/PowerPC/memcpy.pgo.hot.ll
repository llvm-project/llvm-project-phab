...
; RUN: llc -verify-machineinstrs -mcpu=pwr8 -ppc-expand-extra-memcpy < %s | FileCheck %s
...
; CHECK-NEXT:    cmpldi 30, 256
; CHECK-NEXT:    bgt 0, .LBB0_8
; CHECK-NEXT:  # BB#2:
; CHECK-NEXT:    rldicl. 7, 30, 61, 3
; CHECK-NEXT:    clrldi 3, 30, 61
; CHECK-NEXT:    beq 0, .LBB0_5
; CHECK-NEXT:  # BB#3: # %loop-memcpy-expansion.preheader
; CHECK-NEXT:    addi 5, 4, -8
; CHECK-NEXT:    addi 6, 29, -8
; CHECK-NEXT:    mtctr 7
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_4: # %loop-memcpy-expansion
; CHECK:         ldu 7, 8(5)
; CHECK-NEXT:    stdu 7, 8(6)
; CHECK-NEXT:    bdnz .LBB0_4
; CHECK-NEXT:  .LBB0_5: # %loop-memcpy-residual-header
; CHECK-NEXT:    cmpldi 3, 0
; CHECK-NEXT:    beq 0, .LBB0_9
; CHECK-NEXT:  # BB#6: # %loop-memcpy-residual.preheader
; CHECK-NEXT:    addi 5, 30, -1
; CHECK-NEXT:    mtctr 3
