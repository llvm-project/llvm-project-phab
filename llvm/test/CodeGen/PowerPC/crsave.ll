; RUN: llc -O0 -ppc-ignore-percent-prefix -disable-fp-elim \
; RUN:   -mtriple=powerpc-unknown-linux-gnu -mcpu=g5 < %s \
; RUN:   | FileCheck %s -check-prefix=PPC32
; RUN: llc -O0 -ppc-ignore-percent-prefix -mtriple=powerpc64-unknown-linux-gnu \
; RUN:   -mcpu=g5 < %s | FileCheck %s -check-prefix=PPC64
; RUN: llc -O0 -ppc-ignore-percent-prefix \
; RUN:   -mtriple=powerpc64le-unknown-linux-gnu -verify-machineinstrs < %s \
; RUN:   | FileCheck %s -check-prefix=PPC64-ELFv2
