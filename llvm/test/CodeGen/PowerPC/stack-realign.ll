; RUN: llc -ppc-ignore-percent-prefix -mtriple=powerpc64-unknown-linux-gnu \
; RUN:   -mcpu=pwr7 < %s | FileCheck %s
; RUN: llc -ppc-ignore-percent-prefix -mtriple=powerpc64-unknown-linux-gnu \
; RUN:   -mcpu=pwr7 -disable-fp-elim < %s | FileCheck -check-prefix=CHECK-FP %s
; RUN: llc -ppc-ignore-percent-prefix -mtriple=powerpc-unknown-linux-gnu \
; RUN:   -disable-fp-elim < %s | FileCheck -check-prefix=CHECK-32 %s
; RUN: llc -ppc-ignore-percent-prefix -mtriple=powerpc-unknown-linux-gnu \
; RUN:   -disable-fp-elim -relocation-model=pic < %s \
; RUN:   | FileCheck -check-prefix=CHECK-32-PIC %s
