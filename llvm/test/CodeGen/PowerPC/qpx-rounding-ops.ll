...
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=a2q | FileCheck %s
; RUN: llc -verify-machineinstrs < %s -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=a2q \
; RUN:   -enable-unsafe-fp-math | FileCheck -check-prefix=CHECK-FM %s
