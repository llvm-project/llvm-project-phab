...
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=pwr7 < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFSPR
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc64-unknown-linux-gnu -mcpu=pwr8 < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFSPR
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc64le-unknown-linux-gnu < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFSPR
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc-unknown-linux-gnu  < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFSPR
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc-unknown-linux-gnu -mcpu=ppc < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFSPR
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc-unknown-linux-gnu -mcpu=601 < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFTB
; RUN: llc -verify-machineinstrs -ppc-strip-register-prefix \
; RUN:   -mtriple=powerpc-unknown-linux-gnu -mcpu=pwr3 < %s 2>&1 \
; RUN:    | FileCheck %s --check-prefix=CHECK-MFTB
