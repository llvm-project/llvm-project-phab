...
; CHECK: Scale the probablity, before scaling: 0x0020c49c / 0x80000000 = 0.10%
; CHECK: After scaling: 0x006d3a08 / 0x80000000 = 0.33%
; CHECK: Scale the probablity, before scaling: 0x00418937 / 0x80000000 = 0.20%
; CHECK: After scaling: 0x00da740d / 0x80000000 = 0.67%
; CHECK: Scale the probablity, before scaling: 0x25c28f5c / 0x80000000 = 29.50%
; CHECK: After scaling: 0x7ddddddf / 0x80000000 = 98.33%
; CHECK: Scale the probablity, before scaling: 0x003126e9 / 0x80000000 = 0.15%
