...
; CHECK: Remat: %EAX<def,dead,norename> = MOV32r0 %EFLAGS<imp-def,dead,norename>, %AL<imp-def,norename>
}
...
define i32 @test_remat32() {
  ret i32 0
; CHECK: REGISTER COALESCING
; CHECK: Remat: %EAX<def,norename> = MOV32r0 %EFLAGS<imp-def,dead,norename>
}
