...
; VEX-NEXT:    vmovdqa (%rdi), %xmm0
; VEX-NEXT:    vmovdqa 16(%rdi), %xmm1
; VEX-NEXT:    vmovdqa {{.*#+}} xmm2 = [1127219200,1160773632,0,0]
; VEX-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; VEX-NEXT:    vmovapd {{.*#+}} xmm4 = [4.503600e+15,1.934281e+25]
; VEX-NEXT:    vsubpd %xmm4, %xmm3, %xmm3
; VEX-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[2,3,0,1]
; VEX-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; VEX-NEXT:    vsubpd %xmm4, %xmm1, %xmm1
; VEX-NEXT:    vhaddpd %xmm1, %xmm3, %xmm1
; VEX-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm0[0],xmm2[0],xmm0[1],xmm2[1]
; VEX-NEXT:    vsubpd %xmm4, %xmm3, %xmm3
; VEX-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,3,0,1]
; VEX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm2[0],xmm0[1],xmm2[1]
...
; VEX-NEXT:  # BB#17:
; VEX-NEXT:    vcvtsi2ssq %rax, %xmm7, %xmm5
...
; VEX-NEXT:    vaddss %xmm1, %xmm1, %xmm5
; VEX-NEXT:  .LBB80_18:
; VEX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm2[0,1],xmm4[0],xmm2[3]
; VEX-NEXT:    vinsertps {{.*#+}} xmm2 = xmm5[0],xmm6[0],xmm5[2,3]
; VEX-NEXT:    vmovq %xmm0, %rax
; VEX-NEXT:    testq %rax, %rax
; VEX-NEXT:    js .LBB80_19
; VEX-NEXT:  # BB#20:
; VEX-NEXT:    vcvtsi2ssq %rax, %xmm7, %xmm4
