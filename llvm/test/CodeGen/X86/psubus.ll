...
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[3,1,2,3]
; SSE2-NEXT:    movd %xmm3, %ecx
; SSE2-NEXT:    cmpl $65535, %ecx ## imm = 0xFFFF
; SSE2-NEXT:    cmovael %eax, %ecx
; SSE2-NEXT:    movd %ecx, %xmm3
...
; SSSE3-NEXT:    cmovael %eax, %ecx
; SSSE3-NEXT:    movd %ecx, %xmm2
; SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[2,3,0,1]
; SSSE3-NEXT:    movd %xmm3, %ecx
; SSSE3-NEXT:    cmpl $65535, %ecx ## imm = 0xFFFF
; SSSE3-NEXT:    cmovael %eax, %ecx
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm1[3,1,2,3]
; SSSE3-NEXT:    movd %xmm4, %ecx
; SSSE3-NEXT:    cmpl $65535, %ecx ## imm = 0xFFFF
; SSSE3-NEXT:    cmovael %eax, %ecx
; SSSE3-NEXT:    movd %ecx, %xmm4
; SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm1[1,1,2,3]
...
; AVX2-NEXT:    vpminud (%rsi), %ymm1, %ymm1
...
; SSE-NEXT:    movdqa {{.*#+}} xmm2 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
...
; SSE-NEXT:    cmovael %eax, %ecx
; SSE-NEXT:    movd %ecx, %xmm4
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm5[1,1,2,3]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm3[3,1,2,3]
; SSE-NEXT:    movd %xmm5, %ecx
; SSE-NEXT:    cmpl $255, %ecx
; SSE-NEXT:    cmovael %eax, %ecx
; SSE-NEXT:    movd %ecx, %xmm5
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm3[1,1,2,3]
; SSE-NEXT:    movd %xmm6, %ecx
; SSE-NEXT:    cmpl $255, %ecx
; SSE-NEXT:    cmovael %eax, %ecx
; SSE-NEXT:    movd %ecx, %xmm6
...
; SSE-NEXT:    cmovael %eax, %ecx
; SSE-NEXT:    movd %ecx, %xmm3
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm1[1,1,2,3]
; SSE-NEXT:    movd %xmm6, %ecx
; SSE-NEXT:    cmpl $255, %ecx
; SSE-NEXT:    cmovael %eax, %ecx
; SSE-NEXT:    movd %ecx, %xmm6
...
; AVX2-NEXT:    vmovdqu (%rdi), %xmm0
; AVX2-NEXT:    vpbroadcastd {{.*}}(%rip), %ymm1
; AVX2-NEXT:    vpminud 32(%rsi), %ymm1, %ymm2
