...
; SSE41-NEXT:    psubusb %xmm0, %xmm1
; SSE41-NEXT:    movdqu %xmm1, (%rdi)
; SSE41-NEXT:    retq
;
; AVX1-LABEL: test6:
; AVX1:       ## BB#0: ## %vector.ph
...
; SSE41-NEXT:    movdqu (%rsi), %xmm1
; SSE41-NEXT:    movdqu 16(%rsi), %xmm2
...
; SSE41-NEXT:    movdqu (%rsi), %xmm1
; SSE41-NEXT:    movdqu 16(%rsi), %xmm2
; SSE41-NEXT:    movdqu 32(%rsi), %xmm3
; SSE41-NEXT:    movdqu 48(%rsi), %xmm4
; SSE41-NEXT:    movdqa {{.*#+}} xmm5 = [255,255,255,255]
; SSE41-NEXT:    pminud %xmm5, %xmm4
