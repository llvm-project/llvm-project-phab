...
; AVX512F-LABEL: test_v16i32_1_3_5_7_9_11_13_15:
; AVX512F:       # BB#0:
...
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: test_v16i32_1_3_5_7_9_11_13_15:
; AVX512BW:       # BB#0:
...
; AVX512F-LABEL: test_v16i32_0_1_2_12:
; AVX512F:       # BB#0:
; AVX512F-NEXT:    movw $4103, %ax # imm = 0x1007
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vpcompressd %zmm0, %zmm0 {%k1}
...
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: test_v16i32_0_1_2_12:
; AVX512BW:       # BB#0:
; AVX512BW-NEXT:    movw $4103, %ax # imm = 0x1007
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vpcompressd %zmm0, %zmm0 {%k1}
...
; AVX512F-LABEL: test_v16f32_0_1_2_3_4_6_7_10:
; AVX512F:       # BB#0:
; AVX512F-NEXT:    movw $1247, %ax # imm = 0x4DF
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vcompressps %zmm0, %zmm0 {%k1}
; AVX512F-NEXT:    # kill: %YMM0<def> %YMM0<kill> %ZMM0<kill>
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: test_v16f32_0_1_2_3_4_6_7_10:
; AVX512BW:       # BB#0:
; AVX512BW-NEXT:    movw $1247, %ax # imm = 0x4DF
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vcompressps %zmm0, %zmm0 {%k1}
; AVX512BW-NEXT:    # kill: %YMM0<def> %YMM0<kill> %ZMM0<kill>
; AVX512BW-NEXT:    retq
...
; AVX512F-LABEL: test_v16f32_0_1_3_6:
; AVX512F:       # BB#0:
; AVX512F-NEXT:    movw $75, %ax
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vcompressps %zmm0, %zmm0 {%k1}
; AVX512F-NEXT:    # kill: %XMM0<def> %XMM0<kill> %ZMM0<kill>
; AVX512F-NEXT:    vzeroupper
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: test_v16f32_0_1_3_6:
; AVX512BW:       # BB#0:
; AVX512BW-NEXT:    movw $75, %ax
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vcompressps %zmm0, %zmm0 {%k1}
; AVX512BW-NEXT:    # kill: %XMM0<def> %XMM0<kill> %ZMM0<kill>
; AVX512BW-NEXT:    vzeroupper
