...
define zeroext i16 @test_mm512_testn_epi32_mask(<8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
...
; Function Attrs: norecurse nounwind readnone
define zeroext i16 @test_mm512_mask_testn_epi32_mask(i16 zeroext %__U, <8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
...
; Function Attrs: norecurse nounwind readnone
define zeroext i8 @test_mm512_testn_epi64_mask(<8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
...
; Function Attrs: norecurse nounwind readnone
define zeroext i8 @test_mm512_mask_testn_epi64_mask(i8 zeroext %__U, <8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
...
; Function Attrs: norecurse nounwind readnone
define zeroext i16 @test_mm512_mask_test_epi32_mask(i16 zeroext %__U, <8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
...
; Function Attrs: norecurse nounwind readnone
define zeroext i8 @test_mm512_mask_test_epi64_mask(i8 zeroext %__U, <8 x i64> %__A, <8 x i64> %__B) local_unnamed_addr #2 {
