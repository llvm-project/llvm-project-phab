...
; CHECK-NEXT:    andl $57343, %ecx # imm = 0xDFFF
...
; CHECK-NEXT:    orl $384, (%rdi) # imm = 0x180
; CHECK-NEXT:    retq
...
; CHECK:       # BB#0:
; CHECK-NEXT:    movzwl 4(%rdi), %eax
; CHECK-NEXT:    movl $384, %ecx # imm = 0x180
...
; CHECK:       # BB#0:
; CHECK-NEXT:    movzwl 4(%rdi), %eax
; CHECK-NEXT:    movl $-8193, %ecx # imm = 0xDFFF
; CHECK-NEXT:    andl (%rdi), %ecx
