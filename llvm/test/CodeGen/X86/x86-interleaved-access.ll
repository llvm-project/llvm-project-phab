...
; AVX-NEXT:    vhaddpd %ymm3, %ymm2, %ymm2
...
; AVX-NEXT:    vaddpd %ymm3, %ymm2, %ymm2
...
; AVX2-NEXT:    vinserti128 $1, 96(%rdi), %ymm1, %ymm3
; AVX2-NEXT:    vperm2i128 {{.*#+}} ymm0 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vperm2i128 {{.*#+}} ymm1 = ymm1[2,3],mem[2,3]
; AVX2-NEXT:    vpunpcklqdq {{.*#+}} ymm4 = ymm2[0],ymm3[0],ymm2[2],ymm3[2]
; AVX2-NEXT:    vpunpcklqdq {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX2-NEXT:    vpunpckhqdq {{.*#+}} ymm2 = ymm2[1],ymm3[1],ymm2[3],ymm3[3]
; AVX2-NEXT:    vpaddq %ymm5, %ymm2, %ymm2
