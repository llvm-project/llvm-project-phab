...
; X64-AVX-NEXT:    vpaddw %xmm0, %xmm1, %xmm0
; X64-AVX-NEXT:    retq
...
; X86-NEXT:    psllq $6, %xmm2
; X86-NEXT:    movdqa %xmm0, %xmm1
; X86-NEXT:    psllq $4, %xmm1
; X86-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1,2,3],xmm2[4,5,6,7]
; X86-NEXT:    paddq %xmm0, %xmm1
; X86-NEXT:    movdqa %xmm1, %xmm0
; X86-NEXT:    retl
;
...
; X64-NEXT:    psllq $6, %xmm2
; X64-NEXT:    movdqa %xmm0, %xmm1
; X64-NEXT:    psllq $4, %xmm1
; X64-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1,2,3],xmm2[4,5,6,7]
; X64-NEXT:    paddq %xmm0, %xmm1
; X64-NEXT:    movdqa %xmm1, %xmm0
; X64-NEXT:    retq
;
...
; X64-XOP:       # BB#0:
; X64-XOP-NEXT:    vpshlq {{.*}}(%rip), %xmm0, %xmm1
; X64-XOP-NEXT:    vpaddq %xmm0, %xmm1, %xmm0
; X64-XOP-NEXT:    retq
;
; X64-AVX2-LABEL: mul_v2i64_17_65:
; X64-AVX2:       # BB#0:
; X64-AVX2-NEXT:    vpsllvq {{.*}}(%rip), %xmm0, %xmm1
...
; X86:       # BB#0:
; X86-NEXT:    movdqa {{.*#+}} xmm1 = [4,16,32,64]
; X86-NEXT:    pmulld %xmm0, %xmm1
; X86-NEXT:    paddd %xmm1, %xmm0
; X86-NEXT:    retl
;
; X64-LABEL: mul_v4i32_5_17_33_65:
; X64:       # BB#0:
; X64-NEXT:    movdqa {{.*#+}} xmm1 = [4,16,32,64]
; X64-NEXT:    pmulld %xmm0, %xmm1
; X64-NEXT:    paddd %xmm1, %xmm0
; X64-NEXT:    retq
;
; X64-XOP-LABEL: mul_v4i32_5_17_33_65:
; X64-XOP:       # BB#0:
; X64-XOP-NEXT:    vpshld {{.*}}(%rip), %xmm0, %xmm1
; X64-XOP-NEXT:    vpaddd %xmm0, %xmm1, %xmm0
; X64-XOP-NEXT:    retq
;
; X64-AVX2-LABEL: mul_v4i32_5_17_33_65:
; X64-AVX2:       # BB#0:
; X64-AVX2-NEXT:    vpsllvd {{.*}}(%rip), %xmm0, %xmm1
; X64-AVX2-NEXT:    vpaddd %xmm0, %xmm1, %xmm0
; X64-AVX2-NEXT:    retq
...
; X86:       # BB#0:
; X86-NEXT:    movdqa %xmm0, %xmm1
; X86-NEXT:    psllw $3, %xmm1
; X86-NEXT:    psubw %xmm0, %xmm1
; X86-NEXT:    movdqa %xmm1, %xmm0
; X86-NEXT:    retl
;
...
; X86:       # BB#0:
; X86-NEXT:    movdqa %xmm0, %xmm1
; X86-NEXT:    psllq $6, %xmm1
; X86-NEXT:    movdqa %xmm0, %xmm2
; X86-NEXT:    psllq $4, %xmm2
; X86-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1,2,3],xmm1[4,5,6,7]
; X86-NEXT:    psubq %xmm2, %xmm0
; X86-NEXT:    retl
;
; X64-LABEL: mul_v2i64_neg_15_63:
; X64:       # BB#0:
; X64-NEXT:    movdqa %xmm0, %xmm1
; X64-NEXT:    psllq $6, %xmm1
; X64-NEXT:    movdqa %xmm0, %xmm2
; X64-NEXT:    psllq $4, %xmm2
; X64-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1,2,3],xmm1[4,5,6,7]
...
; X64-XOP-NEXT:    vpshlq {{.*}}(%rip), %xmm0, %xmm1
; X64-XOP-NEXT:    vpaddq %xmm0, %xmm1, %xmm0
; X64-XOP-NEXT:    vpsllq $2, %xmm0, %xmm0
; X64-XOP-NEXT:    retq
;
...
; X64-AVX2-NEXT:    vpsllvq {{.*}}(%rip), %xmm0, %xmm1
; X64-AVX2-NEXT:    vpaddq %xmm0, %xmm1, %xmm0
; X64-AVX2-NEXT:    vpsllq $2, %xmm0, %xmm0
; X64-AVX2-NEXT:    retq
...
; X64-NEXT:    retq
;
; X64-XOP-LABEL: mul_v2i16_60_120:
; X64-XOP:       # BB#0:
; X64-XOP-NEXT:    vpshlq {{.*}}(%rip), %xmm0, %xmm1
; X64-XOP-NEXT:    vpsubq %xmm0, %xmm1, %xmm0
; X64-XOP-NEXT:    vpsllq $2, %xmm0, %xmm0
; X64-XOP-NEXT:    retq
;
; X64-AVX2-LABEL: mul_v2i16_60_120:
; X64-AVX2:       # BB#0:
; X64-AVX2-NEXT:    vpsllvq {{.*}}(%rip), %xmm0, %xmm1
; X64-AVX2-NEXT:    vpsubq %xmm0, %xmm1, %xmm0
; X64-AVX2-NEXT:    vpsllq $2, %xmm0, %xmm0
