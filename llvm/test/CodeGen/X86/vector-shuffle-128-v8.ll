...
; SSSE3:       # BB#0:
; SSSE3-NEXT:    pshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,5,7]
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: shuffle_v8i16_01100110:
; AVX2:       # BB#0:
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,0,4,5,6,7]
; AVX2-NEXT:    vpbroadcastq %xmm0, %xmm0
; AVX2-NEXT:    retq
;
; AVX512VL-LABEL: shuffle_v8i16_01100110:
; AVX512VL:       # BB#0:
; AVX512VL-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,0,4,5,6,7]
; AVX512VL-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; AVX512VL-NEXT:    retq
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: shuffle_v8i16_01u0u110:
; AVX2:       # BB#0:
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,0,4,5,6,7]
; AVX2-NEXT:    vpbroadcastq %xmm0, %xmm0
; AVX2-NEXT:    retq
;
; AVX512VL-LABEL: shuffle_v8i16_01u0u110:
; AVX512VL:       # BB#0:
; AVX512VL-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,0,4,5,6,7]
; AVX512VL-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; AVX512VL-NEXT:    retq
...
; AVX:       # BB#0:
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,7,5]
