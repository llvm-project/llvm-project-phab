...
; AVX512BWVL-NEXT:    vmovdqu 16(%rdi), %xmm1
...
; AVX512VL:       # BB#0:
; AVX512VL-NEXT:    vpshuflw {{.*#+}} xmm0 = mem[0,2,2,3,4,5,6,7]
; AVX512VL-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512VL-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; AVX512VL-NEXT:    vpshuflw {{.*#+}} xmm1 = mem[0,2,2,3,4,5,6,7]
...
; AVX512BWVL:       # BB#0:
; AVX512BWVL-NEXT:    vpshuflw {{.*#+}} xmm0 = mem[0,2,2,3,4,5,6,7]
; AVX512BWVL-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512BWVL-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; AVX512BWVL-NEXT:    vpshuflw {{.*#+}} xmm1 = mem[0,2,2,3,4,5,6,7]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm1 = mem[0,2,2,3]
...
; AVX512BW-NEXT:    vpshufd {{.*#+}} xmm1 = mem[0,2,2,3]
