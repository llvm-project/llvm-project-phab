...
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mcpu=knl | FileCheck %s
 ...
 define <16 x i32>@test_int_x86_avx512_mask_pbroadcastd_gpr_512(i32 %x0, <16 x i32> %x1, i16 %mask) {
  ...
  ; CHECK:       ## BB#0:
  ; CHECK:    vpbroadcastd %edi, {{%zmm[0-9]}}
  ; CHECK:    kmovw %esi, %k1
  ; CHECK:    vpbroadcastd %edi, %zmm0 {%k1}
  ; CHECK:    vpaddd %zmm0, {{%zmm[0-9]}}, %zmm0
  ; CHECK:    vpbroadcastd %edi, %zmm1 {%k1} {z}
  ; CHECK:    vpaddd %zmm0, %zmm1, %zmm0
  ; CHECK:    retq
...
declare <16 x i32> @llvm.x86.avx512.mask.pbroadcast.d.gpr.512(i32, <16 x i32>, i16)
  ...
  ; CHECK:       ## BB#0:
  ; CHECK:    vpbroadcastq %rdi, {{%zmm[0-9]}} 
  ; CHECK:    kmovw %esi, %k1
  ; CHECK:    vpbroadcastq %rdi, %zmm0 {%k1}
  ; CHECK:    vpaddq %zmm0, %zmm1, %zmm0
  ; CHECK:    vpbroadcastq %rdi, %zmm1 {%k1} {z}
  ; CHECK:    vpaddq %zmm0, {{%zmm[0-9]}}, %zmm0
  ; CHECK:    retq
