...
; CHECK:       ## BB#0:
; CHECK-NEXT:    vshuff32x4 {{.*#+}} zmm1 = zmm0[8,9,10,11,4,5,6,7,12,13,14,15,8,9,10,11]
; CHECK-NEXT:    kmovw %edi, %k1
; CHECK-NEXT:    vshuff32x4 {{.*#+}} zmm2 {%k1} = zmm0[8,9,10,11,4,5,6,7,12,13,14,15,8,9,10,11]
; CHECK-NEXT:    vaddps %zmm1, %zmm2, %zmm0
; CHECK-NEXT:    retq
...
; CHECK:       ## BB#0:
; CHECK-NEXT:    vshuff64x2 {{.*#+}} zmm1 = zmm0[4,5,2,3,6,7,4,5]
; CHECK-NEXT:    kmovw %edi, %k1
; CHECK-NEXT:    vshuff64x2 {{.*#+}} zmm2 {%k1} = zmm0[4,5,2,3,6,7,4,5]
; CHECK-NEXT:    vaddpd %zmm1, %zmm2, %zmm1
; CHECK-NEXT:    vshuff64x2 {{.*#+}} zmm0 {%k1} {z} = zmm0[4,5,2,3,6,7,4,5]
; CHECK-NEXT:    vaddpd %zmm0, %zmm1, %zmm0
; CHECK-NEXT:    retq
...
; CHECK:       ## BB#0:
; CHECK-NEXT:    vshufi32x4 {{.*#+}} zmm1 = zmm0[8,9,10,11,4,5,6,7,12,13,14,15,8,9,10,11]
; CHECK-NEXT:    kmovw %edi, %k1
; CHECK-NEXT:    vshufi32x4 {{.*#+}} zmm2 {%k1} = zmm0[8,9,10,11,4,5,6,7,12,13,14,15,8,9,10,11]
...
; CHECK:       ## BB#0:
; CHECK-NEXT:    vshufi64x2 {{.*#+}} zmm1 = zmm0[4,5,2,3,6,7,4,5]
; CHECK-NEXT:    kmovw %edi, %k1
; CHECK-NEXT:    vshufi64x2 {{.*#+}} zmm2 {%k1} = zmm0[4,5,2,3,6,7,4,5]
; CHECK-NEXT:    vpaddq %zmm1, %zmm2, %zmm0
; CHECK-NEXT:    retq
