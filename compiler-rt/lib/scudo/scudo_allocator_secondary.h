...
class ScudoLargeMmapAllocator {
 public:
  ...
  void *Allocate(AllocatorStats *Stats, uptr Size, uptr Alignment) {
    ...
    ALIGNED(MinAlignment) ReservedAddressRange *StoredRange =
                          getReservedAddressRange(Ptr);
 ...
 private:
  ...
  const uptr AlignedReservedAddressRangeSize = RoundUpTo(
                                                sizeof(ReservedAddressRange),
                                                MinAlignment);
