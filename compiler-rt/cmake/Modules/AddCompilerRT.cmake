...
# generate_compiler_rt_tests(<test_suite> <test_name>
#                           KIND <custom prefix>
...
function(generate_compiler_rt_tests test_objects test_suite testname arch)
  ...
  add_compiler_rt_test(${test_suite} "${testname}"
    SUBDIR ${TEST_SUBDIR}
    OBJECTS ${${test_objects}}
    DEPS ${TEST_DEPS}
    LINK_FLAGS ${TARGET_LINK_FLAGS} ${TEST_LINK_FLAGS}
    )
...
function(add_compiler_rt_test test_suite test_name)
  ...
  if(TEST_SUBDIR)
    set(output_folder "${output_folder}/${TEST_SUBDIR}")
  endif()
  if(CMAKE_CONFIGURATION_TYPES)
    set(output_folder "${output_folder}/${CMAKE_CFG_INTDIR_INTDIR}")
  endif()
  file(MAKE_DIRECTORY "${output_folder}")
  set(output_bin "${output_folder}/${test_name}")
  if(MSVC)
