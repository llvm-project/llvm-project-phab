...
set(ALL_PROFILE_SUPPORTED_ARCH ${X86} ${X86_64} ${ARM32} ${ARM64} ${PPC64}
    ${MIPS32} ${MIPS64} ${S390X})
set(ALL_TBAASAN_SUPPORTED_ARCH ${X86_64} ${MIPS64} ${ARM64} ${PPC64})
...
if(APPLE)
  ...
  list_intersect(PROFILE_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(TBAASAN_SUPPORTED_ARCH
    ALL_TBAASAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(TBAASAN_SUPPORTED_ARCH ${ALL_TBAASAN_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;tbaasan;tsan;safestack;cfi;esan;scudo)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TBAASAN_SUPPORTED_ARCH AND
  ...
  set(COMPILER_RT_HAS_TBAASAN FALSE)
endif()
