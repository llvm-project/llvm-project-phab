...
; CHECK: { Stmt1[i0, i1] -> [t0 = 0, 0, i0, 1, i1] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt1[i0, i1] -> [t0 = -2 + i0, 0, i0, 1, i1] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt2_copy_no_1[i0] -> [t0 = -1 + i0, 0, i0, 2, 0] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt2_copy_no_1[i0 = 1] -> [t0 = 1, 0, 1, 2, 0]; 
; CHECK-SAME: Stmt0[i0] -> [t0 = 0, 0, i0, 0, 0] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt0[i0] -> [t0 = -2 + i0, 0, i0, 0, 0] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt2[i0] -> [t0 = 0, 0, i0, 2, 0] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt2[i0] -> [t0 = -2 + i0, 0, i0, 2, 0] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt0_copy_no_2[i0] -> [t0 = i0, 0, i0, 0, 0] : 2 <= i0 <= 93; 
; CHECK-SAME: Stmt1_copy_no_2[i0, i1] -> [t0 = i0, 0, i0, 1, i1] : 2 <= i0 <= 93; 
; CHECK-SAME: Stmt5[i0, i1] -> [i0, 1, 0, 1, i1]; 
; CHECK-SAME: Stmt2_copy_no_2[i0] -> [t0 = i0, 0, i0, 2, 0] : 2 <= i0 <= 93; 
; CHECK-SAME: Stmt4[i0] -> [i0, 1, 0, 0, 0]; Stmt6[i0] -> [i0, 1, 0, 2, 0]; 
; CHECK-SAME: Stmt0_copy_no_1[i0] -> [t0 = -1 + i0, 0, i0, 0, 0] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt0_copy_no_1[i0 = 1] -> [t0 = 1, 0, 1, 0, 0]; 
; CHECK-SAME: Stmt1_copy_no_1[i0, i1] -> [t0 = -1 + i0, 0, i0, 1, i1] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt1_copy_no_1[i0 = 1, i1] -> [t0 = 1, 0, 1, 1, i1] }
; CHECK: Function: double_convolution
; CHECK-NOT: Stmt5_copy_no_1
; CHECK: Stmt1_copy_no_1
; CHECK: Stmt1_copy_no_2
; CHECK-NOT: Stmt5_copy_no_1
