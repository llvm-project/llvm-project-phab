; RUN: opt -basicaa -polly-import-jscop -polly-import-jscop-dir=%S -polly-import-jscop-postfix=recompute -polly-ast -analyze -disable-polly-legality -debug < %s 2>&1 | FileCheck %s
...
; CHECK: { Stmt_for_cond1_preheader_copy_no_1[i0] -> [t0 = -1 + i0, 0, i0, 0, 0] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt_for_cond1_preheader_copy_no_1[i0 = 1] -> [t0 = 1, 0, 1, 0, 0]; 
; CHECK-SAME: Stmt_for_inc29[i0, i1] -> [i0, 1, 0, 1, i1]; 
; CHECK-SAME: Stmt_for_cond17_preheader[i0] -> [i0, 1, 0, 0, 0]; 
; CHECK-SAME: Stmt_for_cond1_preheader_copy_no_2[i0] -> [t0 = i0, 0, i0, 0, 0] : 2 <= i0 <= 93; 
; CHECK-SAME: Stmt_for_inc[i0, i1] -> [t0 = 0, 0, i0, 1, i1] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt_for_inc[i0, i1] -> [t0 = -2 + i0, 0, i0, 1, i1] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt_for_inc_copy_no_1[i0, i1] -> [t0 = -1 + i0, 0, i0, 1, i1] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt_for_inc_copy_no_1[i0 = 1, i1] -> [t0 = 1, 0, 1, 1, i1]; 
; CHECK-SAME: Stmt_for_end31[i0] -> [i0, 1, 0, 2, 0]; 
; CHECK-SAME: Stmt_for_end_copy_no_1[i0] -> [t0 = -1 + i0, 0, i0, 2, 0] : 2 <= i0 <= 94; 
; CHECK-SAME: Stmt_for_end_copy_no_1[i0 = 1] -> [t0 = 1, 0, 1, 2, 0]; 
; CHECK-SAME: Stmt_for_inc_copy_no_2[i0, i1] -> [t0 = i0, 0, i0, 1, i1] : 2 <= i0 <= 93; 
; CHECK-SAME: Stmt_for_end[i0] -> [t0 = 0, 0, i0, 2, 0] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt_for_end[i0] -> [t0 = -2 + i0, 0, i0, 2, 0] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt_for_cond1_preheader[i0] -> [t0 = 0, 0, i0, 0, 0] : 0 <= i0 <= 1; 
; CHECK-SAME: Stmt_for_cond1_preheader[i0] -> [t0 = -2 + i0, 0, i0, 0, 0] : 2 <= i0 <= 95; 
; CHECK-SAME: Stmt_for_end_copy_no_2[i0] -> [t0 = i0, 0, i0, 2, 0] : 2 <= i0 <= 93 }
; CHECK: Function: double_convolution
; CHECK-NOT: Stmt_for_inc29_copy_no_1
; CHECK: Stmt_for_inc_copy_no_1
; CHECK: Stmt_for_inc_copy_no_2
; CHECK-NOT: Stmt_for_inc29_copy_no_1
