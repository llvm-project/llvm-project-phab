...
template <class ELFT> struct Files {
  static std::vector<SharedFile<ELFT> *> SharedFiles;
  static std::vector<ObjectFile<ELFT> *> ObjectFiles;
  static std::vector<BitcodeFile *> BitcodeFiles;
  static std::vector<BinaryFile *> BinaryFiles;
};
template <class ELFT> std::vector<SharedFile<ELFT> *> Files<ELFT>::SharedFiles;
template <class ELFT> std::vector<ObjectFile<ELFT> *> Files<ELFT>::ObjectFiles;
template <class ELFT> std::vector<BitcodeFile *> Files<ELFT>::BitcodeFiles;
template <class ELFT> std::vector<BinaryFile *> Files<ELFT>::BinaryFiles;
