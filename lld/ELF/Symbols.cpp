...
bool Symbol::includeInDynsym() const {
  ...
  // loader cannot resolve foo at load-time, it leaves foo's PLT entry
  // zero.  That means when you jump there, it then jumps to an unexpected
  ...
  // is also generally better to let users explicitly control the linker's
  // behavior through command line options rather than changing the
  // behavior implicitly depending on existence or absense of some
  // relocations.)
